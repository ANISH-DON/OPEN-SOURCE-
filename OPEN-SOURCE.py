...
def modules():
	...
	print(' [\u001b[36mâ€¢\033[1;37m] Modules Are Being Installed ')	time.sleep(2)
	...
	animation(' [\u001b[36mâ€¢\033[1;37m] Congrats Modules Are Installed')
...
\033[1;37m     ___      .__   __.  __       _______. __    __  
	...
	if kz in ['2']:
		...
		if len(vin)==0:
			...
			try:geh = lol[geeh]
				...
				print('>> Choose The corrcect shit ')
			...
			input(f'{x}[{m} Click Enter To Get Back{x} ]')
	...
	if kz in ['1']:
		...
		if len(vin)==0:
			...
			try:geh = lol[geeh]
				...
				print('â€¢ RIGHT OPTION CHHOSE GARNA MUJI !!')
		...
		print('â€¢ PLEASE CHOOSE RIGHT OPTION !!')
...
def menu(my_name,my_id):
	...
	print(" [\u001b[36mâ€¢\033[1;37m] Today's date  :",todaydate)

	print(" [\u001b[36mâ€¢\033[1;37m] Your Ip Address :",ip)

	linex()

	print(f""" [\u001b[36m1\033[1;37m] Crack Public           â€¢WORKING\n [\u001b[36m2\033[1;37m] Crack File             â€¢WORKING\n [\u001b[36m3\033[1;37m] Create File            â€¢WORKING\n [\u001b[36m4\033[1;37m] Check Results \n [\u001b[36m0\033[1;37m] Logout Cookies""")
	...
	if Meledak in ['1']:
		...
		animation(' [Ã—] Successfully Logout+Delete Cookies ')
...
def dump_massal():
	...
	try:
		...
		jum = int(input(' [\u001b[36mâ€¢\033[1;37m] Input target amount : '))
	...
	for met in range(jum):
		...
		kl = input(' [\u001b[36mâ€¢\033[1;37m] Enter the Id '+str(yz)+' : ')
	...
	try:
		...
		print(f' [\u001b[36mâ€¢\033[1;37m] Total Id Collected \33[1;32m'+str(len(id)))
		...
		animation(f' [Ã—] Friendlist Not Public {x}')
...
def crack_file():
	...
	print(' [\u001b[36mâ€¢\033[1;37m] Input File Name Without /sdcard ')

	linex()

	o1 = input(' [\u001b[36mâ€¢\033[1;37m] Enter File Name : ')
...
def setting():
	...
	print(''' [\u001b[36mâ€¢\033[1;37m] Method 1 (Best)\n [\u001b[36mâ€¢\033[1;37m] Method 2 \n [\u001b[36mâ€¢\033[1;37m] Method 3''')

	linex()

	hc = input(' [\u001b[36mâ€¢\033[1;37m] Enter : ')
...
def passu():
	...
	print(f' [\u001b[36mâ€¢\033[1;37m] Total IDz : \33[1;32m',str(len(id)))

	print(" [\u001b[36mâ€¢\033[1;37m] You Started Cloning At : "+str(a)+":"+str(lt()[4])+" "+ tag+" ")

	linex()

	prints(f' >> BE PATIENT CRACKING HAS BEEN STARTED ')

	linex()

	prog = Progress(TextColumn(' [â€¢CRACKING]{task.description}'))
	...
	print(' [\u001b[36mâ€¢\033[1;37m] Cloning Complete ')

	print(' [\u001b[36mâ€¢\033[1;37m] OK : %s '%(ok))

	print(' [\u001b[36mâ€¢\033[1;37m] CP : %s '%(cp))
